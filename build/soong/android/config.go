...
func (c *config) GrallocHalVersion() int {
	return *c.productVariables.Gralloc_hal_version
}
...
func (c *deviceConfig) WifiHalConfig() string {
	return String(c.config.productVariables.WifiHalConfig)
}
