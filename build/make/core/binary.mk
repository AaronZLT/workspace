...
# System LSI Defined CFLAGS
ifeq ($(BOARD_CAMERA_USES_EXTENDED_VIDEO_PLANES), true)
LSI_GLOBAL_DEFINES := -DUSE_EXTENDED_VIDEO_PLANES
else
LSI_GLOBAL_DEFINES :=
endif
...
my_target_global_cflags += $(LSI_GLOBAL_DEFINES)
