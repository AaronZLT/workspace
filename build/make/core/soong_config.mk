...
$(call add_json_str,  WifiHalConfig,                     $(SLSI_WIFI_HAL_NL_ATTR_CONFIG))
...
$(call add_json_val,  Gralloc_hal_version,               $(if $(BOARD_USES_EXYNOS_GRALLOC_VERSION),$(BOARD_USES_EXYNOS_GRALLOC_VERSION),0))
