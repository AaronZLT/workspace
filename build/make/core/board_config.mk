...
###########################################
# HACK substitute with the real value of TARGET_COPY_OUT_DEBUG_RAMDISK
# - NonAB Also using force_normal_boot=1 and
#   vendor_debu_ramdisk are using vendor_debug_ramdisk/first_stage_ramdisk
# So, NonAB device cannot do VTS Test with vendor_boot-debug.ramdisk (adb root failed)
ifeq ($(BOARD_USES_SUPPORT_NONAB_GKI),true)
